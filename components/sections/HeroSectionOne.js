...
export default function HeroSectionOne() {
  return (
    <section className="hero-slider-1 relative bg-white pt-12 pb-20 lg:pt-24 lg:pb-32 overflow-hidden">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-8 items-center">
          <div className="flex flex-col gap-6 max-w-2xl">
            ...
            <h1 className="text-5xl font-black leading-[1.1] tracking-tight text-neutral-dark sm:text-6xl lg:text-7xl">
              Hey sis, you belong in <span className="text-primary">tech</span> too.
            </h1>
            <p className="text-lg leading-relaxed text-neutral-gray max-w-lg">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-4">
              ...
              <button
                className="flex items-center gap-2 rounded-full border border-gray-200 bg-white px-6 py-3.5 text-base font-semibold text-neutral-dark hover:border-primary/30 hover:bg-gray-50 transition-all">
          ...
          <div className="relative lg:h-full w-full flex items-center justify-center">
            <div className="relative w-full aspect-[4/3] lg:aspect-square overflow-hidden rounded-2xl bg-gray-100 shadow-2xl rotate-2 hover:rotate-0 transition-transform duration-500">
              <div className="absolute inset-0 bg-cover bg-center"
                data-alt="Three African women working together on laptops in a modern office, smiling"
