    ...
    <section className="py-20 bg-white dark:bg-background-dark relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {/* Card 1 */}
          <div className="group hover:-translate-y-1 transition-transform duration-300 bg-background-light dark:bg-gray-800 rounded-xl p-8 border border-gray-100 dark:border-gray-700 shadow-sm h-full flex flex-col animate-fade-up">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg p-4 mt-auto">
              <p className="text-xs font-bold text-neutral-dark dark:text-white uppercase tracking-wider mb-3">
                Offerings
              </p>
              <ul className="space-y-2">
                <li className="flex items-start gap-2 text-sm text-gray-600 dark:text-gray-300">
                  <span className="material-symbols-outlined text-primary dark:text-blue-400 text-lg shrink-0" aria-hidden="true">
                    check_circle
                  </span>
