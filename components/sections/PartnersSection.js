    ...
    <div className="py-24 bg-white dark:bg-background-dark/80 relative overflow-hidden transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="flex flex-col items-center text-center max-w-[800px] mx-auto mb-10">
              <h2 className="text-primary dark:text-indigo-400 text-sm uppercase tracking-wider mb-3">Our Network</h2>
              <h2 className="text-[#161019] dark:text-white text-3xl md:text-4xl leading-tight tracking-[-0.015em] px-4 pb-4">
