        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/2 bg-[#E9D5FF] dark:bg-purple-900/40 p-8 lg:p-12 transition-colors">
            <div className="grid grid-cols-2 gap-8 h-full">
              ...
              <div className="flex flex-col justify-center">
                <span className="font-display font-bold text-4xl lg:text-[48px] text-primary dark:text-purple-100 mb-1">&lt;30%</span>
                <span className="text-sm text-gray-700 dark:text-purple-200 font-medium">Female Researchers in STEM</span>
              </div>
              <div className="flex flex-col justify-center">
                <span className="font-display font-bold text-4xl lg:text-[48px] text-primary dark:text-purple-100 mb-1">7%</span>
                <span className="text-sm text-gray-700 dark:text-purple-200 font-medium">Funding for Female Founders</span>
              </div>
              <div className="flex flex-col justify-center">
                <span className="font-display font-bold text-4xl lg:text-[48px] text-primary dark:text-purple-100 mb-1">97M</span>
