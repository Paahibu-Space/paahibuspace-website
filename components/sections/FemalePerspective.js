  ...
  return (
    <section className="py-20 bg-white dark:bg-background-dark/50 transition-colors">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12">
          <h2 className="font-display text-3xl lg:text-[36px] text-primary dark:text-white mb-4">Why We Need Female Perspective in Tech</h2>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/2 flex flex-col gap-6 justify-center">
            <div className="flex gap-4 items-start p-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
              ...
              <div>
                <h3 className="text-xl text-primary dark:text-white mb-2">Increased Innovation</h3>
            ...
            <div className="flex gap-4 items-start p-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
              ...
              <div>
                <h3 className="text-xl text-primary dark:text-white mb-2">Effective Leadership</h3>
            ...
            <div className="flex gap-4 items-start p-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
              ...
              <div>
                <h3 className="text-xl text-primary dark:text-white mb-2">Entrepreneurship Growth</h3>
